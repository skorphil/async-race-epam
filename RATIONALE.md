...
FSD structure would probably ended up with 2 pages and single shared layer.
...
- Optimistic updates after removing/resetting the car(now UI is odd, because it's waiting for engine being stopped before updating UI) 
- Better UI components. I used just basic styles without thinking much about design and a11y.
- Writing tests
